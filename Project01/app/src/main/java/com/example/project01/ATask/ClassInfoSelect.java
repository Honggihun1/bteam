...
public class ClassInfoSelect  extends AsyncTask<Void, Void, Void> {

    public ClassInfoSelect(ArrayList<C_infoDTO> dtos, C_infoAdapter adapter, String class_id) {
        this.dtos = dtos;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/app/hamClassInfo";
