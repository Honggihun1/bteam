...
public class IdCheck extends AsyncTask<Void, Void, String> {
    ...
    public IdCheck(String student_id) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            builder.addTextBody("student_id", student_id, ContentType.create("Multipart/related", "utf-8"));  // 변수를 이 이름으로 보냄

            // 전송
            // 전송 Url : 우리가 수정해야 하는 부분
            String postURL = ipConfig + "/app/hongIdCheck";
            ...
            // 응답처리 : DTO 형태 :
            idsDTO = readMessage(inputStream);
            Log.d(TAG, "idsDTO : " + idsDTO);
    ...
    private IdsDTO readMessage(InputStream inputStream) throws IOException {
